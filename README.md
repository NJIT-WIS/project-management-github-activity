...
4.  Git status[3]
5.  Git commit[3]
6.  The aim of Node.js[3]
7.  How to create pull and request and collaborate with teammates[1]
8. Linux Directory listing[2]
9. Build Docker image based on my PC's environment[1]
10. Prepare DockerFile[2]
11. The use of webpack[2]
12. Only add and commit certain file at the same time[1]
...
7. The difference between Git and SVN[2]
8. The details of Watchtower process[1]
9. Combine different commits[1]
10. Build Docker image based on my PC's environment[1]
11. Prepare DockerFile[2]
12. How to use bootstrap for development[2]
13. The logic of login and register page[1]
#### Things we want to know next**
1.  Elastic Search Indexing [2]
2.  Cloud deployment with Kubernetes[3]
3.  Terraform[2]
4.  How to do the permission verification for different role of a system[2]
5.  The logic of login and register page[1]
6.  How to use bootstrap for development[1]
7. Manage submodules in git repo[1]
8. Use tag in git[2]
9. Use vim[2]
...
=======
>>>>>>> d36ad0fe756ba292d740ca64833b831f14e55490
