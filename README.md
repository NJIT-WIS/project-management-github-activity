...
4.  GitPush[2]
5.  cloning git repo and using it[2]
6.  importing files from git to pycharm[1]
7.  Dockerfile and DockerCompose files[1]
8.  Python[2]
9.  Linux[2] 
10.  JavaScript[1]
11. ReactJS[1]
...
2.  Cloud deployment with Kubernetes[5]
3.  Teraform[4]
4.  more about ssh and rsa[1]
5.  Semantic Versioning[2]
6.  GIT Staging[1]
7.  Docker Container[1]
8.  GitHub Actions[1]
9.  Git Merge[1]
10. i dont know kubernetes[1]
11. Cloning git repo via SSH[1]
12. AWS[1]
13. Jenkins[1]
14. Kubernetes[2]
