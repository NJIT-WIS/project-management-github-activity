...
4.  Using Git on command line[1]
5.  Collaborating on GitHub[1]
6.  Git push and pull[1]
7.  Building Docker Image [1]
...
4.  Working with Vi[1]
5.  Webpack[1]
6. How write Automated Tests [1]
7. Devops[1]
8. How to create a webpage[1]
