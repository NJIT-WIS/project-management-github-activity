...
1. Git Stash
2. Issues defaulting to the central repository rather than my personal fork
3. Git Pull
#### Things we want to know next**
1.  Syntastically Awesome Style Sheets (SASS)
2.  Using Kubernetes to deploy application software
