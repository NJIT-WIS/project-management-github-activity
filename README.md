...
4.  Docker Installation[4]
5.  Git push and pull[1]
6.  HTML and CSS[1]
7.  Python Print[1]
8.  Linux Directory listing[2] 
9.  I learned Git[1]
10. I know what docker is[1]
11. I know how live reload is done[1]
12. Azure cloud computing[1]
13. Python programming[1]
14. Flutter mobile app development[1]
15. Python Print[1]
16. Linux Directory listing[2] 
17. Docker Installation[3]
18. Using Git on command line[1]
19. Collaborating on GitHub[1]
20. Git push and pull[1]
21. Building Docker Image [1]

#### Things we don't understand
1. I don't understand how to resolve merge conflicts[1]
2. I don't understand Docker container images and their use[2]
3. How to resolve a daemon issue[2]
4. Git Stash[3]
5. GIT status[2]
6. CI/CD tools[1]
7. difference between docker and github[1]
8. Docker Compose[1]
9. Writing test cases[1]
10. How CI/CD is achieved[1]
11. Responsive design in HTML[1]
12. Flexbox in CSS[1]
13. Grid system in bootstrap[1]
14. GIt pull[2]
15. port issues on docker[1]
16. pull requests on GitHub[1]
17. Watchtower[1]
18. Git merge[1]
