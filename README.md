...
4. How to use git status [3]
5. How to use git checkout to move or create and move to a branch[3]
6. Git add, commit, push, merges and resolving merge conflicts[1]
7. GitHub secrets to add usernames/passwords[1] 
8. Building Docker images though pycharm terminal[1]
#### Things we don't understand
1. How to revert a commit[1]
2. How git stores previous versions[1]
3. What makes git the standard in version control[1]
4. Workflow between repositories[3]
...
3. How to use Terraform to set up Infrastructure as Code[2]
