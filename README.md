...
2.  Building image on Docker[8]
3.  GitHub commands[7]
4.  Docker setup[1]
5.  I know what docker is[4]
6.  I know how live reload is done[1]
7.  Linux Directory listing[2]
8.  Python Print[1]
9.  Linux Directory listing[2] 
10. Azure cloud computing[1]
11. Python programming[1]
12. Flutter mobile app development[1]
13. HTML and CSS[1] 
#### Things we don't understand
1.  Docker Compose[1]
2.  Writing test cases[1]
3.  How CI/CD is achieved[2]
4.  Creating interface[1]
5.  Debugging[2]
6.  project setup[3]
7.  Responsive design in HTML[1]
8.  Flexbox in CSS[1]
9.  Grid system in bootstrap[1]
10. Docker Image and container, repository and desktop [1]
11. difference between docker and github [1]
12. gitHub commit and push[5]
13. Terminal Errors[3]
14. Auto grading[1]
#### Things we want to know next**
1.  How applications are hosted [1]
2.  REST API[1]
3.  Django[1]
4.  agile technology [2]
5.  testing the code in pycharm[3]
6.  Teraform[1]
7.  Elastic Search Indexing [2]
8.  Cloud deployment with Kubernetes [2]
9.  Terraform[2]
10.  Ansible[1]
11. Web project using HTML, CSS, JavaScript[9]
12. Resolving Errors[10]
13. JavaScript [11]
14. Creating interface[1]
15. Debugging[2]
16. project setup[3]
